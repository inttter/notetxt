...
const HeroSection = () => (
  ...
  >
    <h1 className="text-4xl font-semibold tracking-tighter md:tracking-normal text-zinc-300 sm:text-6xl">
      {heroMessage}
    </h1>
    ...
    <div className="mt-10 flex items-center justify-center gap-x-6">
      <Link href="/editor" className="btn text-sm text-zinc-100 bg-[#282828] bg-opacity-80 border-2 border-neutral-700 border-opacity-40 hover:bg-opacity-60 flex items-center">
        <NotebookPen size={15} className="mr-1 text-stone-400" /> Go to Editor
      </Link>
      <Link href="https://github.com/inttter/notetxt" className="text-sm leading-6 text-zinc-300 hover:text-zinc-400 duration-300 flex items-center group">
